...
First time use of \gls{uti}. Then I can use it again as \gls{uti}, or its plural as \glspl{uti}. \Glspl{maths}, for the begging a phrase, or plural like \glspl{maths}. Finally, \acrshort{latex} doesn't work, because it`s not an acronym.

If I need only the acronym, then use \acrshort{scuba}. However, is I need only the full name, the use \acrlong{radar}.
...
\label{fig:Figura_Exemplo_Label}
\end{figure*}
