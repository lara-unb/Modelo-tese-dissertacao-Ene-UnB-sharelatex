...
\titulolinhas[Versão em LaTeX - Overleaf V2]{Template em LaTeX para dissertações da UnB/FT:}
...
\grau{Doutor}{Tese de doutorado}{Engenharia El\'{e}trica}{ENE}{Engenharia de Sistemas Eletrônicos e de Automação}{Faculdade de Tecnologia}{FT}

\datainfo{Junho}{28}{2019}

%% {Traduzido para outro língua}{Título original}
\titulolinguas{LaTeX Template - Overleaf v2 Version}{Template em Latex para dissertações do UnB/FT: Versão em LaTeX - Overleaf V2}
